...
#' @param HGS The class of HGS is 'data.frame'. The golden standard mESC network was constructed from high-throughput ChIP-X and transcriptome data under TF perturbation (high-throughput golden standard). The first column is tfs list and the second one is target genes list.
#'
